#ifndef LP3_IMGUI_CONFIG_HPP
#define LP3_IMGUI_CONFIG_HPP
...
#if defined(LP3_COMPILE_DYNAMIC) || defined(LP3_IMGUI_API_DYNAMIC)
# if defined(LP3_IMGUI_API_CREATE)
#  define LP3_IMGUI_API LP3_SYMBOL_EXPORT
# else
#  define LP3_IMGUI_API LP3_SYMBOL_IMPORT
# endif
#else
# define LP3_IMGUI_API
#endif

#define IMGUI_API LP3_IMGUI_API

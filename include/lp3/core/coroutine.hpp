#ifndef LP3_CORE_COROUTINE_HPP
#define LP3_CORE_COROUTINE_HPP
...
class
LP3_CORE_API
CoroutineFinishedException : public Exception
{
public:
...
class
LP3_CORE_API
CoroutineInvalidStateException : public Exception
{
public:
...
#define LP3_COROUTINE_END() \
        ...
        case(-1): \
            ...
            LP3_THROW(::lp3::core::CoroutineFinishedException); \
            break; \
        default: \
            LP3_LOG_ERROR("Coroutine is in an invalid state!"); \
            LP3_THROW(::lp3::core::CoroutineInvalidStateException); \
            break; \
    }
